...
\begin{document}
\title{Cooperative Transport via Flexible Cable Suspensions:\\ A Hierarchical Architecture with Adaptive Estimation and Safety Guarantees}
