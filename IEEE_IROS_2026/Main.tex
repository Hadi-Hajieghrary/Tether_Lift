...
\subfile{./Sections/Section_I.1_Related_Work}

\section{Contributions}
\label{Sec:Contributions}
\subfile{./Sections/Section_I.2_Contributions}
...
\section{Safety-Inspired Design and Assurance-Oriented Control Architecture}
\label{Sec:Safety-Inspired_Design_and_Assurance-Oriented_Control_Architecture}
\subfile{./Sections/Section_VIII_Safety_Inspired}
