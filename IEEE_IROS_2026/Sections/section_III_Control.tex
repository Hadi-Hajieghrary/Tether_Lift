...
The singularity-free error functions is defined as:
\begin{align}
...
\begin{equation}
  ...
  \label{eq:VR}
\end{equation}
where $\Psi_{R_i} = \frac{1}{2}\tr(I - R_{d_i}^\top R_i)$ is the attitude configuration error and $c>0$ is sufficiently small. With $\Psi_{R_i}(0)<2$:
\begin{equation}
